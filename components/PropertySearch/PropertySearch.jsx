...
export const PropertySearch = () => {
  ...
  const search = async () => {
    ...
    console.log("SEARCH DATA ", data.total);
  };
  ...
  const handlePageClick = async (pageNumber) => {
    ...
    await router.push(
      `${router.query.slug.join(
        "/"
      )}?page=${pageNumber}&petFriendly=${!!petFriendly}&hasParking=${!!hasParking}&minPrice=${minPrice}&maxPrice=${maxPrice}`,
      null,
      {
        shallow: true,
      }
